...
namespace Startupba.Services.Database
{
    ...
    /// </summary>
    public class StartupbaDbContextFactory : IDesignTimeDbContextFactory<StartupbaDbContext>
    {
        public StartupbaDbContext CreateDbContext(string[] args)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<StartupbaDbContext>();
            optionsBuilder.UseSqlServer(connectionString);

            return new StartupbaDbContext(optionsBuilder.Options);
        }
    }
}
