    ...
    public static class DataSeeder
    {
        ...
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Country>().HasData(
                ...
                new Country { Id = 6, Name = "Slovenia", Code = "SI", IsActive = true },
                new Country { Id = 7, Name = "Montenegro", Code = "ME", IsActive = true },
                new Country { Id = 8, Name = "North Macedonia", Code = "MK", IsActive = true },
                new Country { Id = 9, Name = "Italy", Code = "IT", IsActive = true },
                new Country { Id = 10, Name = "Switzerland", Code = "CH", IsActive = true },
                new Country { Id = 11, Name = "Netherlands", Code = "NL", IsActive = true },
                new Country { Id = 12, Name = "France", Code = "FR", IsActive = true },
                new Country { Id = 13, Name = "United Kingdom", Code = "GB", IsActive = true },
                new Country { Id = 14, Name = "United States", Code = "US", IsActive = true },
                new Country { Id = 15, Name = "Turkey", Code = "TR", IsActive = true }
            );
            ...
            modelBuilder.Entity<City>().HasData(
                ...
                new City { Id = 16, Name = "Bihac", CountryId = 1, IsActive = true },
                new City { Id = 17, Name = "Brcko", CountryId = 1, IsActive = true },
                new City { Id = 18, Name = "Trebinje", CountryId = 1, IsActive = true },
                new City { Id = 19, Name = "Osijek", CountryId = 2, IsActive = true },
                new City { Id = 20, Name = "Zadar", CountryId = 2, IsActive = true },
                new City { Id = 21, Name = "Dubrovnik", CountryId = 2, IsActive = true },
                new City { Id = 22, Name = "Nis", CountryId = 3, IsActive = true },
                new City { Id = 23, Name = "Kragujevac", CountryId = 3, IsActive = true },
                new City { Id = 24, Name = "Hamburg", CountryId = 4, IsActive = true },
                new City { Id = 25, Name = "Cologne", CountryId = 4, IsActive = true },
                new City { Id = 26, Name = "Linz", CountryId = 5, IsActive = true },
                new City { Id = 27, Name = "Salzburg", CountryId = 5, IsActive = true },
                new City { Id = 28, Name = "Ljubljana", CountryId = 6, IsActive = true },
                new City { Id = 29, Name = "Maribor", CountryId = 6, IsActive = true },
                new City { Id = 30, Name = "Koper", CountryId = 6, IsActive = true },
                new City { Id = 31, Name = "Podgorica", CountryId = 7, IsActive = true },
                new City { Id = 32, Name = "Budva", CountryId = 7, IsActive = true },
                new City { Id = 33, Name = "Niksic", CountryId = 7, IsActive = true },
                new City { Id = 34, Name = "Skopje", CountryId = 8, IsActive = true },
                new City { Id = 35, Name = "Bitola", CountryId = 8, IsActive = true },
                new City { Id = 36, Name = "Ohrid", CountryId = 8, IsActive = true },
                new City { Id = 37, Name = "Rome", CountryId = 9, IsActive = true },
                new City { Id = 38, Name = "Milan", CountryId = 9, IsActive = true },
                new City { Id = 39, Name = "Naples", CountryId = 9, IsActive = true },
                new City { Id = 40, Name = "Turin", CountryId = 9, IsActive = true },
                new City { Id = 41, Name = "Zurich", CountryId = 10, IsActive = true },
                new City { Id = 42, Name = "Geneva", CountryId = 10, IsActive = true },
                new City { Id = 43, Name = "Bern", CountryId = 10, IsActive = true },
                new City { Id = 44, Name = "Amsterdam", CountryId = 11, IsActive = true },
                new City { Id = 45, Name = "Rotterdam", CountryId = 11, IsActive = true },
                new City { Id = 46, Name = "The Hague", CountryId = 11, IsActive = true },
                new City { Id = 47, Name = "Paris", CountryId = 12, IsActive = true },
                new City { Id = 48, Name = "Lyon", CountryId = 12, IsActive = true },
                new City { Id = 49, Name = "Marseille", CountryId = 12, IsActive = true },
                new City { Id = 50, Name = "London", CountryId = 13, IsActive = true },
                new City { Id = 51, Name = "Manchester", CountryId = 13, IsActive = true },
                new City { Id = 52, Name = "Edinburgh", CountryId = 13, IsActive = true },
                new City { Id = 53, Name = "New York", CountryId = 14, IsActive = true },
                new City { Id = 54, Name = "San Francisco", CountryId = 14, IsActive = true },
                new City { Id = 55, Name = "Chicago", CountryId = 14, IsActive = true },
                new City { Id = 56, Name = "Austin", CountryId = 14, IsActive = true },
                new City { Id = 57, Name = "Istanbul", CountryId = 15, IsActive = true },
                new City { Id = 58, Name = "Ankara", CountryId = 15, IsActive = true },
                new City { Id = 59, Name = "Izmir", CountryId = 15, IsActive = true }
            );
