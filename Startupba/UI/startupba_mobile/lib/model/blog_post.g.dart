...
BlogPost _$BlogPostFromJson(Map<String, dynamic> json) => BlogPost(
  ...
  sharedFromBlogPostId: (json['sharedFromBlogPostId'] as num?)?.toInt(),
  sharedFromTitle: json['sharedFromTitle'] as String?,
  sharedFromAuthorName: json['sharedFromAuthorName'] as String?,
...
Map<String, dynamic> _$BlogPostToJson(BlogPost instance) => <String, dynamic>{
  ...
  'sharedFromBlogPostId': instance.sharedFromBlogPostId,
  'sharedFromTitle': instance.sharedFromTitle,
  'sharedFromAuthorName': instance.sharedFromAuthorName,
