...
class AmenityDetailsScreen extends StatelessWidget {
  ...
  const AmenityDetailsScreen({super.key, required this.amenity});
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(
                  amenity.isActive ? Icons.check_circle : Icons.cancel,
                  color: amenity.isActive
        ...
        Expanded(
          child: _buildDetailCard(
            ...
            children: [
              _buildInfoRow(
                label: 'Status',
                value: amenity.isActive ? 'Active' : 'Inactive',
                icon: amenity.isActive
                    ? Icons.check_circle_outline
                    : Icons.cancel_outlined,
                valueColor: amenity.isActive
                    ? const Color(0xFF5B9BD5)
                    : Colors.grey[600],
              ),
            ],
