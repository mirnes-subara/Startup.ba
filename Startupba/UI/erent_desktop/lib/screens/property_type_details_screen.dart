...
class PropertyTypeDetailsScreen extends StatelessWidget {
  final PropertyType propertyType;

  const PropertyTypeDetailsScreen({super.key, required this.propertyType});
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(
                  propertyType.isActive ? Icons.check_circle : Icons.cancel,
                  color: propertyType.isActive
        ...
        Expanded(
          child: _buildDetailCard(
            ...
            children: [
              _buildInfoRow(
                label: 'Status',
                value: propertyType.isActive ? 'Active' : 'Inactive',
                icon: propertyType.isActive
                    ? Icons.check_circle_outline
                    : Icons.cancel_outlined,
                valueColor: propertyType.isActive
                    ? const Color(0xFF5B9BD5)
                    : Colors.grey[600],
              ),
            ],
